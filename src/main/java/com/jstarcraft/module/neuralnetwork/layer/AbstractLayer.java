...
public abstract class AbstractLayer implements Layer {
	...
	public KeyValue<MathMatrix, MathMatrix> inputKeyValue;

	/** 键为outputData(不可以为null),值为innerError(不可以为null) */
    public KeyValue<MathMatrix, MathMatrix> outputKeyValue;

	/** 键为middleData(不可以为null),值为middleError(不可以为null) */
	public KeyValue<MathMatrix, MathMatrix> middleKeyValue;
