...
public class testBinarySerialization {
    public static void main(String [] args)
    {
        ...
        Serialization.save(linear, ".\\resource\\Serialization\\linear.ser");
        testLinear = (Linear) Serialization.load(".\\resource\\Serialization\\linear.ser");
        Serialization.save(conv2d, ".\\resource\\Serialization\\conv2d.ser");
        testConv2d = (Conv2d) Serialization.load(".\\resource\\Serialization\\conv2d.ser");
        Serialization.save(maxPool2d, ".\\resource\\Serialization\\maxPool2d.ser");
        testMaxPool2d = (MaxPool2d) Serialization.load(".\\resource\\Serialization\\maxPool2d.ser");
        Serialization.save(mseLoss, ".\\resource\\Serialization\\mseLoss.ser");
        testMSELoss = (MSELoss) Serialization.load(".\\resource\\Serialization\\mseLoss.ser");
        Serialization.save(reLU, ".\\resource\\Serialization\\reLU.ser");
        testReLU = (ReLU) Serialization.load(".\\resource\\Serialization\\reLU.ser");
        Serialization.save(sequential, ".\\resource\\Serialization\\sequential.ser");
        testSequential = (Sequential) Serialization.load(".\\resource\\Serialization\\sequential.ser");
        Serialization.save(softmaxWithLoss, ".\\resource\\Serialization\\softmaxWithLoss.ser");
        testSoftmaxWithLoss = (SoftmaxWithLoss) Serialization.load(".\\resource\\Serialization\\softmaxWithLoss.ser");
        Serialization.save(weightInit, ".\\resource\\Serialization\\weightInit.ser");
        testWeightInit = (WeightInit) Serialization.load(".\\resource\\Serialization\\weightInit.ser");
