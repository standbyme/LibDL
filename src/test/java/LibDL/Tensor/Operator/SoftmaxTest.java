...
public class SoftmaxTest {
    ...
    public void testForward() {
        ...
        assertEquals(target, result.data); // 9.685754776000977E-8
        ...
        assertEquals(target, result.data); // 6.305829932292303E-10
        ...
        assertEquals(target, result.data); // 3.725290298461914E-9
        ...
        assertEquals(target, result.data); // 1.241763432820638E-9
    }
    ...
    public void testBackward() {
        ...
        result.grad = Nd4j.create(new double[]{2.18006110191345214844, -3.51054310798645019531, -4.66951799392700195312}).reshape(3);
        result.backward();
        target = Nd4j.create(new double[]{0.53561645746231079102, 0.06330370157957077026, -0.59892022609710693359});
        assertEquals(target, data_to_backward.grad); // 9.685754776000977E-8
        ...
        assertEquals(target, data_to_backward.grad); // 1.1998539169629416E-7
        ...
        assertEquals(target, data_to_backward.grad); // 6.317471464474995E-8
    }
